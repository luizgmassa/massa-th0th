...
| --- | --- | --- | --- | --- |
| Markdown workflows/references/SKILL.md | none (deterministic sensor) | Every AC has a grep sensor; behavior-preservation diff check | `skills/massa-th0th/**/*.md` | `rg` sensors (see Gate Check Commands) |

## Gate Check Commands

> Generated from codebase — all are deterministic `rg` sensors against `skills/massa-th0th/`.
...
1. `rg 'th0th_' skills/massa-th0th/` → **zero matches** (WTA-01/03 — full tree: workflows + references + SKILL.md)
2. `rg -c 'create_checkpoint|list_checkpoints|restore_checkpoint' skills/massa-th0th/workflows/spec-driven.md skills/massa-th0th/workflows/long-session.md skills/massa-th0th/workflows/restart-save.md` → ≥1 each (WTA-04..07)
3. `rg -c 'handoff_begin|handoff_accept|handoff_list_pending|handoff_cancel' skills/massa-th0th/workflows/agent-handoff.md skills/massa-th0th/workflows/restart-load.md` → ≥1 each (WTA-08..10)
4. `rg 'bootstrap' skills/massa-th0th/workflows/onboarding.md` → ≥1 match (WTA-11)
5. `rg 'compact_snapshot' skills/massa-th0th/workflows/long-session.md` → ≥1 match (WTA-13)
6. `rg 'trace_path' skills/massa-th0th/workflows/debug.md` → ≥1 match (WTA-15)
7. `rg 'impact_analysis' skills/massa-th0th/workflows/architecture/architecture-audit.md skills/massa-th0th/workflows/refactor.md` → ≥1 each (WTA-16/17)
8. `rg 'execute_file|execute|batch_execute' skills/massa-th0th/workflows/debug.md skills/massa-th0th/workflows/general.md` → ≥1 each (WTA-18/19)
9. `rg 'synapse_task_begin|synapse_task_end|synapse_prefetch' skills/massa-th0th/workflows/spec-driven.md skills/massa-th0th/workflows/feature.md` → ≥1 each (WTA-20..22)
10. `rg 'read_file|symbol_snippet' skills/massa-th0th/workflows/` → ≥1 match (WTA-23/24)
11. `rg 'memory_update|memory_delete|analytics' skills/massa-th0th/workflows/` → ≥1 match (WTA-25..27)
12. `rg 'checkpoint|handoff_begin|bootstrap|compact_snapshot|trace_path|impact_analysis|execute_file|synapse_prefetch|read_file|symbol_snippet' skills/massa-th0th/SKILL.md` → ≥1 match (WTA-28/29)
13. `rg 'get_architecture' skills/massa-th0th/workflows/architecture/architecture-audit.md` → ≥1 match
14. `rg 'fetch_and_index' skills/massa-th0th/workflows/exploration.md` → ≥1 match
15. `rg 'get_architecture|rename_project|merge_projects|memory_update|memory_delete|create_checkpoint|list_checkpoints|restore_checkpoint|compact_snapshot|bootstrap|handoff_begin|handoff_accept|handoff_cancel|handoff_list_pending|list_proposals|approve_proposal|reject_proposal|execute|execute_file|batch_execute|fetch_and_index|synapse_get|synapse_update|synapse_end|synapse_prefetch|synapse_list|synapse_task_begin|synapse_task_end|symbol_snippet|read_file|impact_analysis|trace_path|get_architecture' skills/massa-th0th/references/th0th-tools.md` → all 52 tools present (WTA-02)
...
**What**: Replace every `th0th_<tool>` reference with the canonical un-prefixed `<tool>` name across ALL files in `skills/massa-th0th/` (workflows, references, SKILL.md). This is a mechanical transform covering ~58 `.md` files.
**Where**: `skills/massa-th0th/**/*.md` (workflows + references + SKILL.md)
**Depends on**: None
...
**Done when**:
- [ ] `rg 'th0th_' skills/massa-th0th/` returns zero matches (full tree, not just workflows)
...
**Gate**: quick — `rg 'th0th_' skills/massa-th0th/` returns zero

**Commit**: `docs(skills): rename th0th_ tool refs to canonical un-prefixed names across full tree`

---

### T2: Expand `references/th0th-tools.md` to full 52-tool matrix
...
**Where**: `skills/massa-th0th/references/th0th-tools.md`
...
**Done when**:
- [ ] `rg 'th0th_' skills/massa-th0th/references/th0th-tools.md` returns zero
...
**Tests**: none (deterministic sensor)
**Gate**: quick — grep each of the 52 tool names in `th0th-tools.md`
...
**Where**: `skills/massa-th0th/SKILL.md`
...
**Done when**:
- [ ] `rg 'checkpoint|handoff_begin|bootstrap|compact_snapshot|trace_path|impact_analysis|execute_file|synapse_prefetch|read_file|symbol_snippet' skills/massa-th0th/SKILL.md` returns ≥1 match
...
**Where**: `skills/massa-th0th/workflows/spec-driven.md`, `skills/massa-th0th/workflows/long-session.md`, `skills/massa-th0th/workflows/restart-save.md`
...
**Done when**:
- [ ] `rg 'create_checkpoint' skills/massa-th0th/workflows/spec-driven.md` returns ≥1
- [ ] `rg 'list_checkpoints|restore_checkpoint' skills/massa-th0th/workflows/spec-driven.md` returns ≥1
- [ ] `rg 'create_checkpoint' skills/massa-th0th/workflows/long-session.md` returns ≥1
- [ ] `rg 'create_checkpoint' skills/massa-th0th/workflows/restart-save.md` returns ≥1
...
**Where**: `skills/massa-th0th/workflows/agent-handoff.md`, `skills/massa-th0th/workflows/restart-load.md`
**Depends on**: T1 (canonical naming)
...
**Done when**:
- [ ] `rg 'handoff_begin' skills/massa-th0th/workflows/agent-handoff.md` returns ≥1
- [ ] `rg 'handoff_accept|handoff_list_pending' skills/massa-th0th/workflows/agent-handoff.md skills/massa-th0th/workflows/restart-load.md` returns ≥1 each
- [ ] `rg 'handoff_cancel' skills/massa-th0th/workflows/agent-handoff.md` returns ≥1
...
**Where**: `skills/massa-th0th/workflows/onboarding.md`
**Depends on**: T1 (canonical naming)
...
**Done when**:
- [ ] `rg 'bootstrap' skills/massa-th0th/workflows/onboarding.md` returns ≥1
...
**Where**: `skills/massa-th0th/workflows/long-session.md`
...
**Done when**:
- [ ] `rg 'compact_snapshot' skills/massa-th0th/workflows/long-session.md` returns ≥1
...
**Where**: `skills/massa-th0th/workflows/debug.md`, `skills/massa-th0th/workflows/architecture/architecture-audit.md`, `skills/massa-th0th/workflows/refactor.md`
**Depends on**: T1 (canonical naming)
...
**Done when**:
- [ ] `rg 'trace_path' skills/massa-th0th/workflows/debug.md` returns ≥1
- [ ] `rg 'impact_analysis' skills/massa-th0th/workflows/architecture/architecture-audit.md` returns ≥1
- [ ] `rg 'impact_analysis' skills/massa-th0th/workflows/refactor.md` returns ≥1
- [ ] `rg 'get_architecture' skills/massa-th0th/workflows/architecture/architecture-audit.md` returns ≥1
...
**Where**: `skills/massa-th0th/workflows/debug.md`, `skills/massa-th0th/workflows/general.md`
**Depends on**: T1 (canonical naming)
...
**Done when**:
- [ ] `rg 'execute_file' skills/massa-th0th/workflows/debug.md` returns ≥1
- [ ] `rg 'execute|batch_execute' skills/massa-th0th/workflows/general.md` returns ≥1
...
**Where**: `skills/massa-th0th/workflows/spec-driven.md`, `skills/massa-th0th/workflows/feature.md`, `skills/massa-th0th/workflows/debug.md`
**Depends on**: T1 (canonical naming)
...
**Done when**:
- [ ] `rg 'synapse_task_begin' skills/massa-th0th/workflows/spec-driven.md skills/massa-th0th/workflows/feature.md` returns ≥1 each
- [ ] `rg 'synapse_task_end' skills/massa-th0th/workflows/spec-driven.md skills/massa-th0th/workflows/feature.md` returns ≥1 each
- [ ] `rg 'synapse_prefetch' skills/massa-th0th/workflows/spec-driven.md skills/massa-th0th/workflows/feature.md skills/massa-th0th/workflows/debug.md` returns ≥1 each
...
**Where**: `skills/massa-th0th/workflows/general.md`, `skills/massa-th0th/workflows/debug.md`, `skills/massa-th0th/workflows/long-session.md`, `skills/massa-th0th/workflows/exploration.md`, and other workflows that read files
**Depends on**: T1 (canonical naming)
**Reuses**: `massa-th0th-memory` SKILL.md (read_file priority 14), `tool-defs-project.ts` read_file schema, `tool-defs-search.ts` symbol_snippet schema, `tool-defs-memory.ts` memory_update/delete/analytics schemas, `tool-defs-hooks-exec.ts` fetch_and_index schema
...
**Done when**:
- [ ] `rg 'read_file' skills/massa-th0th/workflows/` returns ≥1 match
- [ ] `rg 'symbol_snippet' skills/massa-th0th/workflows/` returns ≥1 match
- [ ] `rg 'memory_update' skills/massa-th0th/workflows/general.md skills/massa-th0th/workflows/debug.md skills/massa-th0th/workflows/long-session.md` returns ≥1 total
- [ ] `rg 'memory_delete' skills/massa-th0th/workflows/general.md skills/massa-th0th/workflows/long-session.md` returns ≥1 total
- [ ] `rg 'analytics' skills/massa-th0th/workflows/general.md skills/massa-th0th/workflows/long-session.md` returns ≥1 total
- [ ] `rg 'fetch_and_index' skills/massa-th0th/workflows/exploration.md` returns ≥1
...
**Where**: All `skills/massa-th0th/**/*.md` files touched by T1..T11
...
| T2: Expand th0th-tools.md matrix | 1 reference file | ✅ Granular |
...
**Available MCPs**: massa-th0th (search, recall, remember, index, etc. — the 52 tools being adopted)
**Available Skills**: `massa-th0th` (workflow router), `massa-th0th-memory` (tool priority rules), `synapse-usage` (Synapse lifecycle), `coding-guidelines`

**Selected answer**: No MCP or skill materially changes implementation or verification for this documentation-layer feature. All tasks are Markdown edits with deterministic `rg` sensors. The `massa-th0th` skill is the execution protocol owner (per the Execution Protocol above). `massa-th0th-memory` and `synapse-usage` are reference sources for tool descriptions and lifecycle patterns (read-only, already loaded in context). No additional MCP calls are needed during execution.