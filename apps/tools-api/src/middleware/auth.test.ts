...
describe("authMiddleware", () => {
  ...
  describe("dev mode — MASSA_AI_API_KEY not set", () => {
    beforeEach(() => { delete process.env.MASSA_AI_API_KEY; });
  ...
  describe("production mode — MASSA_AI_API_KEY=test-key", () => {
    beforeEach(() => { process.env.MASSA_AI_API_KEY = "test-key"; });
